...
_ This presentation deals with the effectiveness of different regression models when they are applied to a dataset to predict an attribute_
...
```
Frequencies and Relative frequencies for these variables are
...
```
# Results
Below is the table that contains regression coefficients from all methods
...
we find table of MSE for each regression  technique
